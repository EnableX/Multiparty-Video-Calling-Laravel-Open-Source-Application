# Multi-Party RTC: A Sample Web App using Laravel (PHP Framework) and EnableX Web Toolkit
...
This basic Multi-Party RTC Application is generated using HTML, CSS, Bootstrap v4.0.0-alpha, JavaScript, jQuery, Laravel and EnxRtc (The EnableX Web Toolkit).
